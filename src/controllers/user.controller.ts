...
import { del, get, getModelSchemaRef, param, patch, post, put, requestBody, response, SchemaObject,} from '@loopback/rest';
import { User } from '../models';
import { UserRepository } from '../repositories';

import { inject} from '@loopback/core';
import { Credentials, TokenServiceBindings,  MyUserService,  UserServiceBindings } from '@loopback/authentication-jwt';
...
export class UserController {
  ...
  @put('/users/{id}')
  @response(204, { description: 'User PUT success' })
  async replaceById(
    @param.path.number('id') id: number,
